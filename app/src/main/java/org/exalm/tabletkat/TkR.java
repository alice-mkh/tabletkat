...
public class TkR {
    ...
    public static class id {
        ...
        public static int recents_transition_background;
        public static int recents_transition_placeholder_icon;
        ...
        public static int tablet_back;
        public static int tablet_home;
    ...
    public static void init(XResources res, XModuleResources res2) {
        ...
        id.recents_transition_background = add(res, res2, R.id.recents_transition_background);
        id.recents_transition_placeholder_icon = add(res, res2, R.id.recents_transition_placeholder_icon);
        ...
        id.tablet_back = add(res, res2, R.id.tablet_back);
        id.tablet_home = add(res, res2, R.id.tablet_home);
