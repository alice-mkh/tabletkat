...
public class InputMethodButton extends ImageView {
    ...
    public InputMethodButton(Context context, AttributeSet attrs) {
        ...
        setContentDescription(context.getString(SystemR.string.accessibility_ime_switch_button));
    }

    @Override
    public int getId() {
        return TkR.id.imeSwitchButton;
    }
    ...
    private void refreshStatusIcon() {
        ...
        mIcon.setImageResource(TkR.drawable.ic_sysbar_ime);
    }
