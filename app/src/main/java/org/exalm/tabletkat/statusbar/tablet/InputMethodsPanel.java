...
public class InputMethodsPanel extends LinearLayout implements StatusBarPanel,
    ...
    public void onFinishInflate() {
        mInputMethodMenuList = (LinearLayout) findViewById(TkR.id.input_method_menu_list);
        mHardKeyboardSection = (LinearLayout) findViewById(TkR.id.hard_keyboard_section);
        mHardKeyboardSwitch = (Switch) findViewById(TkR.id.hard_keyboard_switch);
        mConfigureImeShortcut = findViewById(TkR.id.ime_settings_shortcut);
        mConfigureImeShortcut.setOnClickListener(this);

        updateUiElements();

        ((TextView) findViewById(TkR.id.use_physical_keyboard_label)).setText(getContext().getString(SystemR.string.status_bar_use_physical_keyboard));
        ((TextView) findViewById(TkR.id.ime_settings_shortcut)).setText(getContext().getString(SystemR.string.status_bar_input_method_settings_configure_input_methods));
    }
    ...
    public void openPanel() {
        ...
        if (mInputMethodSwitchButton != null) {
            mInputMethodSwitchButton.setIconImage(TkR.drawable.ic_sysbar_ime_pressed);
        }
    }
    ...
    public void closePanel(boolean closeKeyboard) {
        ...
        if (mInputMethodSwitchButton != null) {
            mInputMethodSwitchButton.setIconImage(TkR.drawable.ic_sysbar_ime);
        }
        if (closeKeyboard) {
    ...
    private View createInputMethodItem(
        ...
        final View view = View.inflate(mContext, TkR.layout.system_bar_input_methods_item, null);
        final ImageView subtypeIcon = (ImageView)view.findViewById(TkR.id.item_icon);
        final TextView itemTitle = (TextView)view.findViewById(TkR.id.item_title);
        final TextView itemSubtitle = (TextView)view.findViewById(TkR.id.item_subtitle);
        final ImageView settingsIcon = (ImageView)view.findViewById(TkR.id.item_settings_icon);
        final View subtypeView = view.findViewById(TkR.id.item_subtype);
        if (subtypeName == null) {
        ...
        if (!TextUtils.isEmpty(settingsActivity)) {
            ...
            view.findViewById(TkR.id.item_vertical_separator).setVisibility(View.GONE);
        ...
        view.setBackgroundResource(SystemR.drawable.status_bar_item_background);
        settingsIcon.setContentDescription(getContext().getString(SystemR.string.accessibility_settings_button));
        return view;
    }
        ...
        if (mRadioViewAndImiMap.containsKey(selectedView)) {
            for (View radioView: mRadioViewAndImiMap.keySet()) {
                RadioButton subtypeRadioButton =
                        (RadioButton) radioView.findViewById(TkR.id.item_radio);
