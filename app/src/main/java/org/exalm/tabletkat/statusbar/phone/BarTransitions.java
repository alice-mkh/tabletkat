...
package org.exalm.tabletkat.statusbar.phone;
...
public class BarTransitions {
    ...
    public static final boolean HIGH_END = (Boolean) XposedHelpers.callStaticMethod(ActivityManager.class, "isHighEndGfx");
    ...
    private static class BarBackgroundDrawable extends Drawable {
        ...
        public BarBackgroundDrawable(Context context, int gradientResourceId) {
            ...
            if (DEBUG_COLORS) {
                ...
                mOpaque = res.getColor(SystemR.color.system_bar_background_opaque);
                mSemiTransparent = res.getColor(SystemR.color.system_bar_background_semi_transparent);
            }
